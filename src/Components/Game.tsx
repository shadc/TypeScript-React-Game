...
const useGameState = () => {
    ...
    // Note - using the "as" statement will prevent this from being type = 'never' and causing problems
    const [candidateNums, setCandidateNums] = useState([] as number[]);
    const [secondsLeft, setSecondsLeft] = useState(10);
  
    // Set a timer effect to "refresh" the state by running the setSecondsLeft every second.
    useEffect(() => {
  ...
  const Game = (props : IGameInterface) => {
